...
public class ForgetPassword extends AppCompatActivity {
    ...
    ImageView imageviewshowhidepassword, imageviewshowhidepassword1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageviewshowhidepassword = findViewById(R.id.password_show0);
        ...
        imageviewshowhidepassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new_password.getTransformationMethod().equals(HideReturnsTransformationMethod.getInstance())) {
        ...
        imageviewshowhidepassword1 = findViewById(R.id.password_show1);
        imageviewshowhidepassword1.setImageResource(R.drawable.img_1);
        imageviewshowhidepassword1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (confirm_password.getTransformationMethod().equals(HideReturnsTransformationMethod.getInstance())) {
                    ...
                    imageviewshowhidepassword1.setImageResource(R.drawable.img);
                }
            }
        });
